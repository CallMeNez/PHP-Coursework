...
<p>Crypto Machine Description: <input type="text" name="crypto_machine_description" value="" size="$input_field_maximum_characters" maxlength="$input_field_maximum_characters" placeholder="Enter machine description (400 characters max)" required="required" />></p>
